const config = {
  ...
  siteUrl: 'https://unsupervisedpapers.com', // Domain of your website without pathPrefix.
  pathPrefix: '', // Prefixes all links. For cases when deployed to example.github.io/gatsby-advanced-starter/.
  siteDescription:
    'An open-source directory of unsupervised, semi-supervised and self-supervised machine learning papers with links to resources such as demos, talks and code.', // Website description used for RSS feeds/meta description tag.
